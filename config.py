...
parser.add_argument('--TICK', type=int, default=400)           # 1 tick = 1000 images = (1000/batch_size) iter.
parser.add_argument('--max_resl', type=int, default=10)          # 10 --> 1024
parser.add_argument('--trns_tick', type=int, default=2)        # transition tick
parser.add_argument('--stab_tick', type=int, default=2)        # stabilization tick
